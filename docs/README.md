...
The deployment url is: [https://arquisoft.github.io/lomap_es6c/](https://arquisoft.github.io/lomap_es6c/).
...
If we want to deploy it to GitHub pages, so it is accesible via [https://arquisoft.github.io/lomap_es6c/](https://arquisoft.github.io/lomap_es6c/) we need to execute `npm run deploy`.
